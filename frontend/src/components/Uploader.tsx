          ...
          {upload && showUploadProgress && (
            <>
              ...
              <div className="flex items-center space-x-4">
                ...
                <button
                  className="px-4 py-2 rounded inset-shadow-sm inset-shadow-indigo-500"
                  onClick={() => {
                    if (isUploadRunning) {
                      upload.abort();
                      setIsUploadRunning(false);
          ...
          {upload && showPreviousUploads && previousUploads.length > 0 && (
            <>
              ...
              <div className="flex space-x-4">
                <button
                  className="bg-blue-500 text-whitepx-4 py-2 rounded inset-shadow-sm inset-shadow-indigo-500 cursor-pointer"
                  onClick={() => {
                ...
                <button
                  className="bg-gray-300 text-gray-700 px-4 py-2 rounded inset-shadow-sm inset-shadow-indigo-500"
                  onClick={startUpload}
                >
                  No, start over
                </button>
